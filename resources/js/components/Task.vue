			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3><span class="glyphicon glyphicon-dashboard"></span> Assignment Dashboard</h3>
						<br>
						<button @click="initAddTask()" class="btn btn-success">Add new Assignment</button>
					</div>
						...
						<table class="table table-bordered table-striped table-responsive" v-if="tasks.length > 0">
							<tbody>
								...
								<tr v-for="(task, index) in tasks">
									...
									<td>
										<button @click="initUpdate(index)" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit"></span></button>
										<button @click="deleteTask(index)" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></button>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="descr">Decription:</label>
							<textarea class="form-control" name="description" id="descr" cols="30" rows="10" placeholder="Task Description" v-model="task.description"></textarea>
						</div>
					</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="descr">Decription:</label>
							<textarea name="description" id="descr" cols="30" rows="10" placeholder="Task Description" v-model="update_task.description"></textarea>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<script>
	export default {
		...
		methods: {
			...
			readTasks(){
				axios.get('https://localhost:8000/task')
				.then(response => {
